...
<head>
    ...
    <!-- Web App Manifest for PWA - 这能让它在手机上像App一样运行 -->
    <link rel="manifest" href="data:application/manifest+json,{'name':'10天计划','short_name':'10天计划','start_url':'.','display':'standalone','background_color':'#f4f1ee','theme_color':'#2d6a4f'}">
